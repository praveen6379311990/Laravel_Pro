@extends('layout.app')
@section('main')
<h5><i class="bi bi-pencil-square"></i> Edit New Product</h5>
            <hr />
            <nav class="my-3">
                <ol class="breadcrumb">
                ...
                <form action="/products/{{$product->id}}/update" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row mb-3">
                        <div class="col-md-12">
                            ...
                            <textarea id="description" name="description" style="resize: none; height: 150px"
                                class="form-control @if ($errors->has('description')) {{ 'is-invalid' }} @endif" placeholder="Enter Description">{{old('description',$product->description)}}</textarea>
